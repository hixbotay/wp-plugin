<?php
/*
Plugin Name: Visa booking	
Plugin URI: http://freelancerviet.net/wordpress/plugins/visa-fvn.zip
...
class HBFactory {
	...
	private function includes(){
		...
		require_once HB_PATH.'libraries/model.php';
	...
	public static function getUser($user_id = null)
	{
		...
		if(!self::$user[$id]){
			...
			if($user->ID){
				...
				if(!self::$user[0]){
					self::$user[0] = new FVN-extensionUser();
				}
			}
		}
