			...
			<table class="wp-list-table widefat fixed striped posts">
				...
				<tbody>
					<?php foreach ($this->items as $item){?>
						...
						<td><a
							href="admin.php?page=period&layout=edit&id=<?php echo $item->id?>"><?php echo __('Edit')?></a>
							<a href="javascript:void(0)" class="fvn-function" data-ask="1" data-href="<?php echo admin_url('admin.php?hbaction=period&task=delete&id='.$item->id)?>"><?php echo __('Delete')?></a></td>
					</tr>
					<?php }?>
				</tbody>
			</table>
